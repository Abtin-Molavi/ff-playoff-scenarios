...
Loaded 10 teams: Abtin Rasoulian, Ben Smith, ...
Enter player name to analyze: Abtin Rasoulian

Analyzing scenarios for Abtin Rasoulian to make the playoffs...
42 scenarios found.
If these outcomes occur, then Abtin Rasoulian is guaranteed to make the playoffs...
 Case 1:
   Abtin Rasoulian wins vs Kevin P AND
   Sam loses vs Ben
...
```
